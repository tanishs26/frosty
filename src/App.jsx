  ...
  return (
    <main>
      ...
      <footer class="  bottom-0 left-0 z-20 w-full p-4 bg-white border-t border-gray-200 shadow-sm md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800 dark:border-gray-600">
        <span class="text-sm text-gray-500 sm:text-center dark:text-indigo-400">
          © 2023{"  "}
          <a
        ...
        <ul class="flex flex-wrap items-center mt-3 text-sm font-medium text-indigo-500 dark:text-indigo-400 sm:mt-0">
          <li>
